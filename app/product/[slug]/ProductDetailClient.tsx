  ...
  return (
    <div className='mr-auto ml-auto'>
      ...
      {productLoading ? (
        ...
        <div className='lg:pt-[7.125rem] pt-[3.125rem] '>
                    ...
                    {sortedProductVariations?.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className={`
                px-5 relative overflow-hidden py-3 max-md:text-[0.8125rem] text-base sm:text-[16px] font-medium
          ...
          `}
              ...
              {(themeId === 3 || themeId === 4 || themeId === 6) && (
                <>
                  <div className='flex xl:flex-row sm:flex gap-4 mb-3.5'>
                    <div className='flex sm:gap-4 gap-2 w-full whitespace-nowrap'>
                      {product?.in_stock === 1 && (
                        // !product?.subscribed_product
                        // ? product?.status === 1
                        // : product?.status === 1 &&
